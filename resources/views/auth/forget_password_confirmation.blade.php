...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="imagex-icon" href="{{ url("auth") }}/assets/img/favicon/favicon.ico" />
      ...
      <div class="authentication-inner row">
        ...
        <div class="d-none d-lg-flex col-lg-7 p-0">
          <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
            <img
              src="{{ url("auth") }}/assets/img/illustrations/page-pricing-enterprise.png"
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            @endif
            <!-- /Logo -->
            <h3 class="mb-1 fw-bold">Recovery link has been sent 👋</h3>

            <div class="row">
                <p>We have sent a link via SMS to your phone. Please click on the link to change your password</p>
